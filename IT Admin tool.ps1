...
function CreateForm {
    ...
    #[reflection.assembly]::loadwithpartialname("System.Drawing") | Out-Null
        ...
        #Form Parameter
        $formMain.Text = "Glidewell Laboratories - IT System Helper"
        ...
        $mainLink0.text = "IT Support Portal"
        $mainLink0.AutoSize = $true
        $mainLink0.width = 25
        $mainLink0.height = 10
        $mainLink0.location = New-Object System.Drawing.Point(400, 5)
        $mainLink0.LinkColor = "BLACK" 
        $mainLink0.ActiveLinkColor = "BLACK" 
        $mainLink0.add_Click( { [system.Diagnostics.Process]::start("http://itsm:8080") })
        ...
        $mainLink1.text = "Corporate Connection"
        $mainLink1.AutoSize = $true
        $mainLink1.width = 25
        $mainLink1.height = 10
        $mainLink1.location = New-Object System.Drawing.Point(400, 27)
        $mainLink1.LinkColor = "BLACK" 
        $mainLink1.ActiveLinkColor = "BLACK" 
        $mainLink1.add_Click( { [system.Diagnostics.Process]::start("http://corporateconnection/") })
        ...
        $mainLink4.text = "Employ Self Service"
        $mainLink4.AutoSize = $true
        $mainLink4.width = 25
        $mainLink4.height = 10
        $mainLink4.location = New-Object System.Drawing.Point(400, 49)
        $mainLink4.LinkColor = "BLACK" 
        $mainLink4.ActiveLinkColor = "BLACK" 
        $mainLink4.add_Click( { [system.Diagnostics.Process]::start("http://corporateconnection/sites/ESS/BP/Business%20Portal%20Common%20Pages/Home.aspx") })
        ...
        $mainLink5.text = "Bradford Network Sentry"
        $mainLink5.AutoSize = $true
        $mainLink5.width = 25
        $mainLink5.height = 10
        $mainLink5.location = New-Object System.Drawing.Point(400, 71)
        $mainLink5.LinkColor = "BLACK" 
        $mainLink5.ActiveLinkColor = "BLACK" 
        $mainLink5.add_Click( { [system.Diagnostics.Process]::start("https://gl-misbfnslv.glidewelldental.com:8443/HostsTab.jsp") })
        ...
        $mainLink6.text = "Microsoft Intune"
        $mainLink6.AutoSize = $true
        $mainLink6.width = 25
        $mainLink6.height = 10
        $mainLink6.location = New-Object System.Drawing.Point(400, 93)
        $mainLink6.LinkColor = "BLACK" 
        $mainLink6.ActiveLinkColor = "BLACK" 
        $mainLink6.add_Click( { [system.Diagnostics.Process]::start("http://aka.ms/intuneportal") })
        ...
        $mainLink7.text = "WebJEA Tools"
        $mainLink7.AutoSize = $true
        $mainLink7.width = 25
        $mainLink7.height = 10
        $mainLink7.location = New-Object System.Drawing.Point(400, 115)
        $mainLink7.LinkColor = "BLACK" 
        $mainLink7.ActiveLinkColor = "BLACK" 
        $mainLink7.add_Click( { [system.Diagnostics.Process]::start("https://desktoptools/desktoptools/") })
        ...
        $mainLink8.text = "PME 4"
        $mainLink8.AutoSize = $true
        $mainLink8.width = 25
        $mainLink8.height = 10
        $mainLink8.location = New-Object System.Drawing.Point(400, 137)
        $mainLink8.LinkColor = "BLACK" 
        $mainLink8.ActiveLinkColor = "BLACK" 
        $mainLink8.add_Click( { [system.Diagnostics.Process]::start("https://ucprovmgrexp/pme/index.php/user/login") })
        ...
        $mainLabel1.text = "Glidewell Laboratories"
        $mainLabel1.AutoSize = $true
        $mainLabel1.width = 25
        $mainLabel1.height = 10
        $mainLabel1.location = New-Object System.Drawing.Point(400, 265)
